...
import * as funcs from "../utils/showFuncs";
import * as USerInserter from "../Controllers/UserInserter";
import '../css/common.css';

const lisaKasutaja= "Lisa kasutaja";
const register = lisaKasutaja;
...
//----------------------------POST------------------------------------
      ...
      if(userData.password && userData.password_conf){
        if(userData.password !== userData.password_conf){
            ...
            if(userData.username && userData.phone && userData.password){
                USerInserter.addUser(userData, this);//, evt);
            }
        }
      }
      else{
    ...
    render() {
        ...
        const password = "Salajane kasutajanimi:";
      ...
      return (
        <div className="relativePosition">
            ...
            <div className="logout" onClick={this.handleRegisterUser}>
                {lisaKasutaja}
            </div>
